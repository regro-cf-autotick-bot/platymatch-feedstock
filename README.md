...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/platymatch-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15363&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/platymatch-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `platymatch` can be installed with:

```
conda install platymatch
```

It is possible to list all of the versions of `platymatch` available on your platform with:
